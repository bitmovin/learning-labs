...
export default class ConfigProvider {
    ...
    public getHttpInputFilePathWithAC3EnglishSurroundSound(): string {
        return this.getOrThrowException(
            'HTTP_INPUT_ENGLISH_AUDIO_FILE_PATH',
            'The path and filename for a file containing a video with a 5.1 audio stream. Example: videos/1080p_Sintel_Surround.mp4'
        );
    }

    public getHttpInputFilePathWithAC3SpanishSurroundSound(): string {
        return this.getOrThrowException(
            'HTTP_INPUT_SPANISH_AUDIO_FILE_PATH',
            'The path and filename for a file containing a video with a 5.1 audio stream. Example: videos/1080p_Sintel_Surround.mp4'
        );
    }
